...
def main(page: ft.Page):
    ...
    def load_tasks():
        ...
        for task in tasks:
            ...
            task_list.controls.append(view_tasks(task_id, task_text))
    ...
    def view_tasks(task_id, task_text):
        ...
        def del_task(_):
            ...
            task_field.value = "Данные успешно удаленны! Все кнопки деактивированны!"

        save_button = ft.IconButton(ft.Icons.SAVE, on_click=save_task, disabled=True)
        delete_button = ft.IconButton(ft.Icons.DELETE, ft.Colors.RED ,on_click=del_task, disabled=False)
    ...
    def add_task_db(_):
        if task_input.value:
            ...
            print(f"Задача {new_task_id} успешно добавлена! Его id - {new_task_id}")

            task_list.controls.append(view_tasks(new_task_id, task_text))
